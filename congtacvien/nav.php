...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="//zalo.me/vankhanh4g" class="nav-link">LIÊN HỆ KỸ THUẬT</a>
        </li>
        <li  class="header-logo">
                        <a href="index.php">
                        <center><img src="<?=$site_logo;?>" alt="ADMIN VIETNAM" style="height:50px"></center>
                        </a>
        </li>
    </ul>
        ...
        <li class="nav-item dropdown">
            <!-- Message Start -->
                    <a href="dang-xuat.php" class="nav-link">
                                <p><i class="nav-icon fa fa-sign-out-alt" aria-hidden="true"></i>
                    </div>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="uytin.php" class="nav-link">
                                <p><i class="nav-icon fa fa-address-card-o"></i>       TẠO HỒ SƠ UY TÍN</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="suauytin.php" class="nav-link">
                                <p><i class='nav-icon fa fa-window-maximize'></i> HỒ SƠ HIỆN CÓ</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="dang-xuat.php" class="nav-link">
